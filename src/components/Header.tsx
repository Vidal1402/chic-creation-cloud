      ...
      <div className="container mx-auto flex items-center justify-between">
        <a href="#" className="flex items-center gap-3 group">
          ...
          <div className="hidden sm:block">
            <span className="text-xl font-serif text-foreground tracking-wide">Vértice</span>
            <p className="text-[9px] tracking-[0.25em] text-primary uppercase font-medium">
            ...
            <nav className="container mx-auto py-6 flex flex-col gap-2">
              {navLinks.map((link) => (
                <a
                  ...
                  className="px-4 py-3 text-lg font-medium text-muted-foreground hover:text-primary hover:bg-primary/5 rounded-lg transition-all"
                >
                  {link.label}
                </a>
              ))}
